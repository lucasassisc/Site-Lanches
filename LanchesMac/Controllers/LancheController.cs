...
namespace LanchesMac.Controllers
{
    public class LancheController : Controller
    {
        ...
        public IActionResult List(string categoria)
        {
            ...
            {
                //------------------------------------------------------------------------------------------------------------------------------
                //Código para verificar as categorias, o grande problema desse fonte é que se precisar adicionar outra categoria teria que ficar colocando
                //manualmente, ou se alguma categoria alterar teria que refatorar o código. 
                //if (string.Equals("Normal", categoria, StringComparison.CurrentCultureIgnoreCase))
                //{
        ...
        public ViewResult Search(string searchString)
        {
            ...
            else
            {
                ...
                // Se contem o lanche que eu digite, quando digite no formulario 
                if (lanches.Any())
                {
